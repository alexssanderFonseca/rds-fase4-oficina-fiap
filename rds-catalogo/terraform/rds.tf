...
resource "aws_secretsmanager_secret" "rds_password_secret" {
  name        = "rds-catalogo/${aws_db_instance.academico_rds.identifier}-new/password"
...
resource "aws_db_instance" "academico_rds" {
  identifier            = "catalogo-oficina-rds"
  engine                = "postgres"
  engine_version        = "18"
